...
public class ModBlocks {
    ...
    public static final Block FUCK_ORE = registerBlock("fuck_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.of(Material.METAL).slipperiness(1f).strength(4f).requiresTool(), UniformIntProvider.create(3,10)));

    public static final Block HARD_FUCK_ORE = registerBlock("hard_fuck_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.of(Material.METAL).slipperiness(1f).strength(5f).requiresTool(), UniformIntProvider.create(3,10)));
